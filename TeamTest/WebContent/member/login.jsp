...
<body>
<%
	System.out.println("login.jsp: " + session.getAttribute("email"));
%>
			...
			<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
				<div class="login-reg-bg">
					<div class="log-reg-area sign">
						...
						<form action="./LoginAction.me" method="post">
							<div class="form-group">	
								<input type="text" id="loginEmail" name="email" required="required"/>
								<label class="control-label" for="input">이메일</label><i class="mtrl-select"></i>
							</div>
							
							<div class="form-group">	
								<input type="password" id="loginPass" name="pass" required="required"/>
								<label class="control-label" for="input">비밀번호</label><i class="mtrl-select"></i>
							</div>
							
							<div class="checkbox">
								<label>
									<input type="checkbox" name="loginCheck"/><i class="check-box"></i>로그인 상태 유지
								</label>
							</div>
					...
					<div class="log-reg-area reg">
						...
						<form action="./Join.me" method="post" id="joinFr">
							<div class="form-group">	
							...
							<div class="checkbox">
								<label>
									<input type="checkbox" id="tosCheck" name="tosCheck"/><i class="check-box"></i>약관에 동의하십니까?
							...
							<div class="submit-btns">
								<button class="mtr-btn signup" id="joinSubmitBtn" onclick="join();"><span>회원가입</span></button>
							</div>
						</form>
					</div>
				</div>
